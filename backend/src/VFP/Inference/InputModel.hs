...
data InputExpression = InputValueDefinition InputType String InputExpression
                     | InputApplication InputType InputExpression InputExpression 
                     ...
                     | InputValueConstraint InputType InputExpression
                     | InputTypeHole InputType
                     deriving (Show, Eq) 

getInputType :: InputExpression -> InputType 
getInputType (InputValueDefinition typ _ _) = typ
...
getInputType (InputValueConstraint typ _) = typ
